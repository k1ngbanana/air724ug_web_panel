...
-- 通知类型, 支持配置多个
-- NOTIFY_TYPE = { "custom_post", "telegram", "pushdeer", "bark", "dingtalk", "feishu", "wecom", "wecom_app", "pushover", "inotify", "next-smtp-proxy", "gotify", "serverchan", "pushplus", "wxpusher" }
NOTIFY_TYPE = {  }
...
-- wecom 应用通知配置, https://developer.work.weixin.qq.com/document/path/90236
-- 请求方式：POST（HTTPS）
...
-- wxpusher 通知配置, https://wxpusher.zjiecode.com/
WXPUSHER_APPTOKEN = ""
WXPUSHER_UIDS = ""
WXPUSHER_SUMMARY = "来自 Air724UG 的通知"
...
-- pushplus 通知配置, https://www.pushplus.plus/
PUSHPLUS_TOKEN = ""
PUSHPLUS_TITLE = "来自 Air724UG 的通知"
--WEBSOCKET公网地址 ws:// 开头
WEBSOCKET_URL=""
